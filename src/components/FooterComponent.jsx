      ...
      <div className="fixed bottom-4 right-4 flex flex-col flex-col-reverse gap-2 space-y-4">
        ...
        {showIcons && (
          <div className="flex flex-col space-y-4">
            ...
            <a href="tel:+918074130576" className="bg-green-500 text-white p-3 rounded-full shadow-lg hover:bg-green-600">
              <FaPhone />
            </a>
            <a href=""  className="bg-green-500 text-white p-3 rounded-full shadow-lg hover:bg-green-600" style={{ backgroundColor: 'blue' }}>
              <FaLinkedin />
            </a>
            <a href="https://wa.me/918074130576" target='_blank' className="bg-green-500 text-white p-3 rounded-full shadow-lg hover:bg-green-600">
              <FaWhatsapp />
            </a>
          </div>
        )}
