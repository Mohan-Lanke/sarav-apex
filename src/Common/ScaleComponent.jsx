...
const ScaleComponent = () => {
  ...
  return (
    <div className="overflow-hidden py-5 w-10/12 mx-auto">
      ...
      <div className='text-white text-left mb-5 text-orange-400 font-bold' style={{ fontFamily: 'Rubik, sans-serif',fontSize:'30px' }}>Core Values</div>
        ...
        {values.map((value, index) => (
          ...
          >
            <div className="relative flex items-center justify-center h-full w-full">
              ...
              >
                <h3 className="text-lg font-semibold mt-2" style={{ fontFamily: 'Rubik, sans-serif' }}>{value.title}</h3>
                <p className="text-center text-gray-600" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>{value.description}</p>
              </div>
            </div>
          </div>
        ))}
