...
import Mass from "../assets/product_chips.jpg";
...
const Products = () => {
  ...
  useEffect(() => {
    const validIds = ["quartz_lumps", "quartz_grits", "quartz_sands", "raming_mass"];
    const idFromParams = params?.id || new URLSearchParams(location.search).get("id");

    if (idFromParams && validIds.includes(idFromParams)) {
      const element = document.getElementById(idFromParams);
      if (element) {
        const yOffset = -70;
    ...
    <section className="bg-[#1D2124]">
      ...
      <section className="md:w-10/12 mx-auto">
        ...
        <div id="quartz_lumps" className="flex flex-col md:flex-row gap-2 pt-8 md:pt-12">
          ...
          <div className="px-8 flex items-center justify-center basis-7/12">
            <p className="text-gray-400 font-normal md:text-md text-md text-justify">
              Quartz lumps are natural chunks of quartz mineral that are usually found in large masses. They are made up of silicon dioxide (SiO2) and can be translucent or opaque. Quartz lumps are valued for their purity, which determines their quality and suitability for a variety of industrial applications.
            </p>
          </div>
        </div>
        ...
        <div id="quartz_grits" className="flex flex-col md:flex-row md:flex-row-reverse gap-2 pt-8 md:pt-12">
          ...
          <div className="px-8 flex items-center justify-center basis-7/12">
            <p className="text-gray-400 font-normal md:text-md text-md text-justify">
              Quartz grit is a versatile material that has a wide range of applications across various industries. Rajasthan, the largest state in India, is known for its abundant deposits of high-quality quartz silica sand, which is used to produce quartz grit of various sizes.
            </p>
          </div>
        </div>
        ...
        <div id="quartz_sands" className="flex flex-col md:flex-row gap-2 pt-8 md:pt-12">
          ...
          <div className="px-8 flex items-center justify-center basis-7/12">
            <p className="text-gray-400 font-normal md:text-md text-md text-justify">
              Silica sand, also known as quartz sand or industrial sand is made of silicon dioxide or silica. Silica sand has been useful in glass manufacturing, sand blasting, concrete and mortar mixing, water filtration, landscaping and other construction services.
            </p>
          </div>
        </div>
        ...
        <div id="raming_mass" className="flex flex-col md:flex-row md:flex-row-reverse gap-2 pt-8 md:pt-12">
          ...
          <div className="px-8 flex items-center justify-center basis-7/12">
            <p className="text-gray-400 font-normal md:text-md text-md text-justify">
              Ramming mass is a refractory material used to line furnaces and protect them from corrosion, erosion, and anti-coating. It's made from a blend of silica grains and a binder like boric acid. Ramming mass is used in a variety of applications.
            </p>
          </div>
        </div>
