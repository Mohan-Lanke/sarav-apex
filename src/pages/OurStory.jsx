...
const numCount = [
  { id: 1, title: "Avg. Team’s Experience", count: 17.5, addOn: "years" },
...
const OurStory = () => {
  ...
  return (
    <div className="bg-[#1D2124] h-full overflow-hidden">
          ...
          <div className="w-full md:w-1/2 text-left px-5">
            <FadeUp>
              <div className="flex items-center gap-2 mb-4">
                ...
                >
                  About Us
                  {/* - <span className="!text-orange-600 " style={{fontSize:'20px'}}>SaravApex</span> */}
                </h2>
      ...
      <section className="pt-8 md:pt-12">
        <div className="w-9/12 md:flex mx-auto">
          <div className="md:w-6/12 flex items-center justify-center mt-4" style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div className="flex gap-4 items-center mb-3">
              <p className="text-2xl md:text-5xl text-white md:px-4" style={{ fontFamily: 'Rubik, sans-serif', textAlign: 'center' }}>
                <ZoomIn duration={3} options={{ threshold: 0.3 }}>
                  We are trusted by<br /> our customers
                </ZoomIn>
              </p>
            </div>
          </div>
          <div className="md:w-6/12 pb-5 relative">
            <div className="flex gap-4 items-center mb-3">
      ...
      <section className="mt-5">
        <div className="bg-transparent sm:px-30 lg:px-60 mt-13 mb-5">
          <div className="bg-[#33C6FC] bg-opacity-20 mx-auto text-white shadow-lg rounded-lg p-8">
            ...
            <p className="mb-4 leading-relaxed" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', lineHeight: '1.8', wordSpacing: '2px' }}>
            ...
            <p className="leading-relaxed" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', lineHeight: '1.8', wordSpacing: '2px' }}>
