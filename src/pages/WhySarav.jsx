        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-24">
          <div className="space-y-8">
            <FadeUp>
              ...
              <p className="text-sm text-gray-400 font-normal pt-4" style={{ height: '200px', fontFamily: 'Plus Jakarta Sans, sans-serif', lineHeight: '1.8', wordSpacing: '2px' }}>
          ...
          <div className="space-y-8">
            <FadeUp>
              ...
              <p className="text-sm text-gray-400 font-normal pt-5" style={{ height: '200px', fontFamily: 'Plus Jakarta Sans, sans-serif', lineHeight: '1.8', wordSpacing: '2px' }}>
            ...
            <FadeUp>
              ...
              <p className="text-sm text-gray-400 font-normal pt-5" style={{ height: '200px', fontFamily: 'Plus Jakarta Sans, sans-serif', lineHeight: '1.8', wordSpacing: '2px', marginTop: '5px' }}>
